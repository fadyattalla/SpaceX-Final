...
def get_scatter_chart(selected_site, slider_value):
    min_range, max_range = slider_value
    mask = (spacex_df['Payload Mass (kg)'] > min_range) & (spacex_df['Payload Mass (kg)'] < max_range)

    selected_launchsite = spacex_df[spacex_df['Launch Site'] == selected_site]
    if selected_site == 'ALL':
        ...
        fig = px.scatter(selected_launchsite[mask], 
            x='Payload Mass (kg)', 
            y='class', 
            color='Booster Version Category'
        )
